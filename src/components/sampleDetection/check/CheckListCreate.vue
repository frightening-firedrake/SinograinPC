<template>
  <div class='listpagewrap' id='listpagewrap'>
    ...
    <div class="fromwrap" id="print" style="background:rgba(241, 241, 241, 1);">
      <!--表单-->
      <!--<hr>-->
      <bwsl-check-from v-if="checktype=='bwsl'||checktype=='cdjl'" :formdatas="formdatas.bwsl" @submit="submit"></bwsl-check-from>
      ...
      <!--<hr>-->
      <cdjl-check-from v-if="checktype=='cdjl'||checktype=='bwsl'" :formdatas="formdatas.cdjl" @submit="submit"></cdjl-check-from>
      <!--<hr>-->
  ...
  methods: {
    ...
    saveUrlcomputed() {
      if (this.checktype == "bwsl" || this.checktype == "cdjl") {
        this.saveUrlend = "/grain/smallSample/addCheck1";
      } else if (this.checktype == "sfcd") {
        this.saveUrlend = "/grain/smallSample/addCheck3";
      } else if (this.checktype == "zfsz") {
        this.saveUrlend = "/grain/smallSample/addCheck8";
      } else if (this.checktype == "mtpc") {
        this.saveUrlend = "/grain/smallSample/addCheck61";
      } else if (this.checktype == "dscd") {
        this.saveUrlend = "/grain/smallSample/addCheck7";
      } else if (this.checktype == "mjxs") {
        this.saveUrlend = "/grain/smallSample/addCheck4";
      } else if (this.checktype == "ympc") {
        this.saveUrlend = "/grain/smallSample/addCheck62";
      }
    ...
    save() {
      ...
      this.formdatas[this.checktype]["inspectState"] = "3";
      this.formdatas[this.checktype]["inspector"] = this.userName;
      this.$http({
        method: "post",
        url: this.saveUrl,
        transformRequest: [
    ...
    save2() {
      var cdjlbwsl = {};
      cdjlbwsl["smallSampleNum"] = this.$route.query.smallSampleNum;
      cdjlbwsl["inspectState"] = "3";
      cdjlbwsl["inspector"] = this.userName;
      for (const value in this.formdatas.cdjl) {
        cdjlbwsl[value] = this.formdatas.cdjl[value];
      }
      for (const value in this.formdatas.bwsl) {
        cdjlbwsl[value] = this.formdatas.bwsl[value];
      }
      // console.log(cdjlbwsl);
      // 提交保存
      this.$http({
        method: "post",
        url: this.saveUrl,
    ...
    return {
      ...
      formdatas: {
        ...
        bwsl: {
          ...
          b_xiangduishidu: "",
          b_jiancefangfa: "",
          b_yiqishebei_mingcheng_1: "2",
          b_yiqishebei_mingcheng_2: "2",
          b_yiqishebei_mingcheng_3: "2",
        ...
        //    	水分测定
        sfcd: {
          s_table_version: "SXZCZJ/JL003-2015",
          s_riqi: new Date(),
          s_shiwen: "",
          s_xiangduishidu: "",
          s_jiancefangfa: "",
        ...
        mjxs: {
          ...
          m_xiangduishidu: "",
          m_jiancefangfa: "",
          m_yiqishebei_mingcheng_1: "",
          m_yiqishebei_mingcheng_2: "",
          m_yiqishebei_mingcheng_3: "",
        ...
        //    	脂肪酸值
        zfsz: {
          zf_table_version: "SXZCZJ/JL008-2015",
          zf_riqi: new Date(),
          zf_shiwen: "",
          zf_xiangduishidu: "",
          zf_jiancefangfa: "",
          zf_yiqishebei_mingcheng_1: "",
          zf_yiqishebei_mingcheng_2: "",
          zf_yiqishebei_bianhao_1: "",
          zf_yiqishebei_bianhao_2: "",
          shiyangzhiliang_1: "",
          shiyangzhiliang_2: "",
          shiyangshuifen: "",
          koh_rongyenongdu: "",
        ...
        //    	玉米品尝
        ympc: {
          ym_table_version: "SXZCZJ/JL009-2015",
          ym_riqi: new Date(),
          ym_pinpingyuan: "",
          wotouqiwei: "",
          wotouseze: "",
        ...
        //    	毒素测定
        dscd: {
          zj_table_version: "SXZCZJ/JL002-2015",
          zj_riqi: new Date(),
          zj_shiwen: "",
          zj_xiangduishidu: "",
          zj_jiancefangfa: "",
          zj_yiqishebei_mingcheng_1: "",
          zj_yiqishebei_mingcheng_2: "",
        ...
        cdjl: {
          ...
          c_xiangduishidu: "",
          c_jiancefangfa: "",
          c_yiqishebei_mingcheng_1: "",
          c_yiqishebei_mingcheng_2: "",
          c_yiqishebei_mingcheng_3: "",
          c_yiqishebei_mingcheng_4: "",
